		...
		<?php
			...
			if (!is_singular() && !empty($lawn_gardner_embeds)) {
			    ...
			    foreach ($lawn_gardner_embeds as $lawn_gardner_embed) {
			        ...
			        if (strpos($lawn_gardner_embed, 'video') !== false || strpos($lawn_gardner_embed, 'youtube') !== false || strpos($lawn_gardner_embed, 'vimeo') !== false || strpos($lawn_gardner_embed, 'dailymotion') !== false || strpos($lawn_gardner_embed, 'vine') !== false || strpos($lawn_gardner_embed, 'wordPress.tv') !== false || strpos($lawn_gardner_embed, 'hulu') !== false) {
			            ?>
