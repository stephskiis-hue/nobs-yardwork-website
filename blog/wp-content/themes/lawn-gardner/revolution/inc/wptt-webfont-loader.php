	...
	class WPTT_WebFont_Loader {
		...
		public function get_remote_files_from_css() {
			...
			foreach ( $font_faces as $font_face ) {
				...
				preg_match_all( '/font-family.*?\;/', $style, $matched_lawn_gardner_font_families );
				...
				$font_family = 'unknown';
				if ( isset( $matched_lawn_gardner_font_families[0] ) && isset( $matched_lawn_gardner_font_families[0][0] ) ) {
					$font_family = rtrim( ltrim( $matched_lawn_gardner_font_families[0][0], 'font-family:' ), ';' );
